...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      <div className="max-w-7xl mx-auto py-24 sm:py-32 px-4 md:px-8 lg:px-10">
        ...
        <p className="text-muted-foreground text-sm md:text-base max-w-sm md:text-center md:mx-auto">
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[2px] bg-gradient-to-t from-primary/60 to-primary from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>
